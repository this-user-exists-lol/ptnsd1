function scr_characterspr() {
	if (character == "P")
	{
	    ...
	    spr_haulingidle = spr_player_grabbing
	    spr_haulingwalk = spr_player_grabbingmove
	    spr_haulingstart = spr_player_grabbingstart
	    spr_haulingfall = spr_player_grabbingfallNEW
	    spr_haulingland = spr_player_grabbingjump
