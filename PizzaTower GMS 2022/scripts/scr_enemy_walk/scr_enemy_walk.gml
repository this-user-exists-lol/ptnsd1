function scr_enemy_walk() {
	...
	image_speed = 0.35
	if ((scr_solid((x + 1), y) && (image_xscale == 1)) || ((scr_solid((x - 1), y) && (image_xscale == -1)) || place_meeting((x + hsp), y, obj_hallway) || place_meeting((x + (image_xscale * 15)), y, obj_enemyturn)))
	{
	...
	{
	    if (!(scr_solid((x + (image_xscale * 15)), (y + 31)) || place_meeting((x + (image_xscale * 15)), (y + 31), obj_platform) || place_meeting((x + (image_xscale * 15)), y, obj_enemyturn)))
	    {
