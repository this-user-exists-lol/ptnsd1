function scr_player_mach3() {
	...
	if (fightball == 0)
	{
	    ...
	    if ((floor(image_index) == (image_number - 1)) && ((sprite_index == spr_rollgetup) || (sprite_index == spr_mach3hit) || (sprite_index == spr_player_mach4boost)))
	        sprite_index = spr_mach4
	    if ((sprite_index == spr_mach2jump) && (grounded && (vsp > 0)))
	        sprite_index = spr_mach4
	}
	if ((sprite_index == spr_player_mach4boost) && (!instance_exists(crazyruneffectid)))
	{
	...
	if ((!instance_exists(obj_superdashcloud)) && (grounded))
		instance_create((x - 100 * xscale), y, obj_superdashcloud)
