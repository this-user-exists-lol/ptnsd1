...
{
	if (state == states.mach2 || state == states.mach3 || state == states.machroll || state == states.knightpepslopes || state == states.tumble || state == states.hookshot)
	{
	...
	if (vsp >= 0 && (state == states.freefall || state == states.freefallland || state == states.facestomp))
	{
