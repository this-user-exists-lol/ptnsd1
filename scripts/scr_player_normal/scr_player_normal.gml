function scr_player_normal() {
	...
	if ((character == "P") || (character == "N"))
	{
	    if ((machslideAnim == 0) && ((landAnim == 0) && (shotgunAnim == 0)))
	    {
	        ...
	        if (move != 0)
	        {
	            ...
	            idle = 0
	            facehurt = 0
				if sprite_index != spr_player_turnaround
				{
		            if ((global.minutes == 0) && (global.seconds == 0))
				...
				if ((floor(image_index) == (image_number - 1)) && (sprite_index == spr_player_turnaround))
				{
		            if ((global.minutes == 0) && (global.seconds == 0))
		                sprite_index = spr_hurtwalk
		            else if (angry == 1)
	...
	if ((move != 0 && sprite_index != spr_player_turnaround) && (((floor(image_index) == 3) || (floor(image_index) == 8)) && (steppy == 0)))
	{
